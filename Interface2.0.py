...
class interface:
    ...
    def fenprincip(self):
        """crée la fenetre principale de l'interface en lancant toute les fonctions nécessaires """
        self.fen=Tk()
...
###############################################################################
    ...
    def boutons(self):
        ...
        self.BS=Checkbutton(self.frameson1,text="tir-canon",variable=self.musique,command=self.Music1).pack(side=LEFT,padx=10,pady=10)

        self.BS1=Checkbutton(self.frameson1,text="canon",variable=self.mus,command=self.Music2).pack(side=LEFT,padx=10,pady=10)
...
###############################################################################
    ...
    def musique(self):
        pygame.init()
        self.sony = pygame.mixer.Sound("musique/ocean1.wav")
        self.sony.play()
        self.son1 = pygame.mixer.Sound("musique/canon1.wav")
        self.son2 = pygame.mixer.Sound("musique/tir-canon1.wav")
