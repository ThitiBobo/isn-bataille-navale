# Créé par savary-derelle, le 22/04/2016 en Python 3.2
from tkinter import *
from final import*
###############################################################################
#Menu Principale#
...
class interface:
    ...
    def frame(self):
        ...
        self.frame3=Frame(self.can,bg='#5B75AB')
    ...
    def menu(self):
        ...
        self.label=Label(self.frame3,text="Bataille Navale!",bg='#1D3877',fg='#E0D16F',font="Elephant 70 bold",relief=RAISED).pack(side=LEFT,padx=5,pady=5)
