...
class interface:
    ...
    def menu(self):
        ...
        self.b1=Button(self.frame2, text ='Multijoueur', height=1 ,width=15, bg='#799ACC',fg='#7B6C0D',font="Elephant 30 bold",relief=GROOVE, cursor="boat").pack(padx=0,pady=0)
        ...
        self.b3=Button(self.frame2, text ='Quitter', height=1 ,width=15, bg='#799ACC',fg='#7B6C0D',font="Elephant 30 bold",relief=GROOVE, cursor="boat",command=self.fen.destroy).pack(padx=0,pady=0)
...
###############################################################################
    ...
    def boutons(self):
        ...
        self.BS=Button(self.frameson1, text ='OUI', height=1 ,width=15, bg='#799ACC',fg='#7B6C0D',font="Elephant 30 bold",relief=GROOVE, cursor="boat").pack(padx=0, pady=0)

        self.BS1=Button(self.frameson1, text ='NON', height=1,width=15, bg='#799ACC',fg='#7B6C0D',font="Elephant 30 bold",relief=GROOVE, cursor="boat").pack(padx=0,pady=0)
...
###############################################################################
    ...
    def boutonV(self):
        ...
        self.BV=Button(self.framevideo1, text ='Interface Surprise', height=1 ,width=15, bg='#799ACC',fg='#7B6C0D',font="Elephant 30 bold",relief=GROOVE, cursor="boat",command=self.randominter).pack(padx=0, pady=0)
    ...
    def randominter(self):
        ...
        colorB=self.choice(colorB)
        colorF=self.choice(colorF)
